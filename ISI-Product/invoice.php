    ...
    <div class="w-full max-w-2xl bg-[#130000] border border-[#150101] rounded-[30px] p-8 shadow-[0_10px_50px_rgba(0,0,0,0.8)]">
        ...
        <div class="mb-6">
            ...
            <div class="space-y-1 text-sm bg-white/5 p-4 rounded-2xl border border-white/5">
                ...
                <p class="text-grey-300"><?= $transaksi['nama_pembeli']; ?></p>
                <p class="text-white">Email/Nomor  : </p>
                <P class="text-hrey-300"><?= $transaksi['email_pembeli']; ?> / <?= $transaksi['no_hp_pembeli']; ?></P>
                <p class="text-white mt-2">Alamat</p>
                <p class="text-gray-300"><?= $transaksi['alamat_pengiriman']; ?></p>
            </div>
        </div>

        <div class="mb-8">
            <h3 class="text-gray-400 text-sm font-semibold mb-2 uppercase tracking-wider">Item</h3>
            <div class="bg-white/5 p-4 rounded-2xl border border-white/5 flex justify-between items-center">
                ...
                <div class="text-right">
                    ...
                    <p class="font-bold text-emerald-400 text-lg">Rp<?= number_format($transaksi['gross_amount'], 0, ',', '.'); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-between items-center border-t border-white/10 pt-6">
            ...
            <div class="flex gap-3 w-full sm:w-auto">
                ...
                <a href="../home/home.php" class="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-blue-500 hover:bg-blue-400 text-white font-semibold text-sm transition text-center shadow-[0_0_15px_rgba(168,85,247,0.4)]">
                    Kembali ke Home
                </a>
            </div>
        </div>
